...
export function City({ country, city, thumbnail, flag }: CityProps) {
  return (
    <Box borderRadius="4px" overflow="hidden">
      <Image
        alt={city}
        src={`/img/cities/${thumbnail}.png`}
        h="170px"
        w="100%"
      />
      ...
      <Flex p="6" align="center" justify="space-between" bg="white" border="1px" borderColor="yellow.300" borderTop="0">
        ...
        <Image alt={country} src={`/img/flags/${flag}.png`} h="30px" w="30px" borderRadius="50%" objectFit="cover" />
      </Flex>
    </Box>
  )
}